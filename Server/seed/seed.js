...
// stockReceived is now embedded in each project document
const PROJECTS = [
  {
    id:'PRJ-001', name:'Main Kitchen — Block A', location:'Hyderabad, Telangana',
    address:'Plot 12, KPHB Industrial Area, Kukatpally, Hyderabad – 500072',
    status:'Active', manager:'Rajesh Kumar', phone:'+91 98765 43210',
    email:'rajesh@adjmarine.com', description:'Primary kitchen facility for daily meal preparation',
    username:'kitchen_a', password:'kitchen@123', capacity:'500', createdAt:'2026-01-15',
    stockReceived: [
      { id:'SR-1736935200000', adminName:'sdj', date:'15 Jan 2026', time:'11:00 AM',
        submittedAt:'2026-01-15T11:00:00.000Z', totalValue:5980, approvalStatus:'pending',
        items:[
          { itemId:'INV-001', itemName:'Rice Lalitha',      category:'Grains & Pulses',  quantity:50, unit:'kg', rate:48,  total:2400, supplier:'Lalitha Stores',     notes:'Monthly stock — Jan batch' },
          { itemId:'INV-063', itemName:'Cooking Oil',       category:'Oils & Fats',       quantity:20, unit:'L',  rate:155, total:3100, supplier:'Ruchi Oils & Fats', notes:'' },
          { itemId:'INV-029', itemName:'Coriander Powder',  category:'Spices & Masalas',  quantity:4,  unit:'kg', rate:120, total:480,  supplier:'SpiceHub India',     notes:'' },
        ]},
      { id:'SR-1737021600000', adminName:'sdj', date:'16 Jan 2026', time:'09:30 AM',
        submittedAt:'2026-01-16T09:30:00.000Z', totalValue:3520, approvalStatus:'pending',
        items:[
          { itemId:'INV-004', itemName:'Moong Dal',       category:'Grains & Pulses', quantity:20, unit:'kg', rate:110, total:2200, supplier:'Maha Grains Co.',      notes:'Restock after weekly usage' },
          { itemId:'INV-086', itemName:'Tea Powder Agni', category:'Beverages',       quantity:3,  unit:'kg', rate:380, total:1140, supplier:'National Foods Ltd.', notes:'' },
          { itemId:'INV-092', itemName:'Salt',            category:'Packaged Foods',  quantity:10, unit:'kg', rate:18,  total:180,  supplier:'Krishna Traders',     notes:'' },
        ]},
    ],
  },
  {
    id:'PRJ-002', name:'Staff Canteen — Block B', location:'Hyderabad, Telangana',
    address:'Block B, Corporate Campus, Gachibowli, Hyderabad – 500032',
    status:'Under Maintenance', manager:'Sunita Rao', phone:'+91 91234 56789',
    email:'sunita@adjmarine.com', description:'Staff canteen serving 200+ employees',
    username:'canteen_b', password:'canteen@123', capacity:'200', createdAt:'2026-02-10',
    stockReceived: [],
  },
  {
    id:'PRJ-003', name:'Offshore Vessel — MV Adjmarine', location:'Visakhapatnam, Andhra Pradesh',
    address:'Berth 14, Outer Harbour, Visakhapatnam Port – 530035',
    status:'Active', manager:'Capt. Arjun Nair', phone:'+91 94455 66778',
    email:'arjun@adjmarine.com', description:'Galley stock for offshore crew (30 persons)',
    username:'vessel_mv1', password:'vessel@123', capacity:'30', createdAt:'2026-03-01',
    stockReceived: [
      { id:'SR-1740826800000', adminName:'sdj', date:'01 Mar 2026', time:'08:00 AM',
        submittedAt:'2026-03-01T08:00:00.000Z', totalValue:9070, approvalStatus:'pending',
        items:[
          { itemId:'INV-002', itemName:'Basmathi Rice',  category:'Grains & Pulses', quantity:80, unit:'kg', rate:65,  total:5200, supplier:'Lalitha Stores',     notes:'Vessel departure stock — 30-day voyage' },
          { itemId:'INV-064', itemName:'Ghee Amul',      category:'Oils & Fats',      quantity:5,  unit:'kg', rate:540, total:2700, supplier:'Amul Distributors', notes:'' },
          { itemId:'INV-030', itemName:'Chilli Powder',  category:'Spices & Masalas', quantity:3,  unit:'kg', rate:180, total:540,  supplier:'SpiceHub India',     notes:'' },
          { itemId:'INV-093', itemName:'Sugar',          category:'Packaged Foods',   quantity:15, unit:'kg', rate:42,  total:630,  supplier:'Krishna Traders',    notes:'' },
        ]},
    ],
  },
];
...
async function seed() {
  try {
    ...
    // Projects: upsert metadata + embedded stockReceived seed data.
    // On re-seed, stockReceived is reset to the seed state.
    let projCount = 0;
    for (const proj of PROJECTS) {
      await Project.updateOne({ id: proj.id }, { $set: proj }, { upsert: true });
      projCount++;
    }
    console.log(`Upserted ${projCount} projects (with embedded stockReceived)`);
